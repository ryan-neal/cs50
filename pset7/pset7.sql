...
INSERT INTO `history` VALUES ('JUNO','Buy',100,43,11,'2016-04-14 00:25:50'),('AAPL','Buy',10,101,9,'2016-04-14 00:28:15'),('AAPL','Buy',10,101,9,'2016-04-14 00:28:18'),('AMZN','Sell',200,615,11,'2016-04-14 00:29:22'),('MSFT','Buy',5000,55,11,'2016-04-14 02:00:40');
...
LOCK TABLES `portfolio` WRITE;
/*!40000 ALTER TABLE `portfolio` DISABLE KEYS */;
INSERT INTO `portfolio` VALUES (0,0,'aapl',50),(1,9,'aapl',50),(0,11,'AAPL',50),(0,11,'GOOG',50),(0,11,'JUNO',100),(0,11,'MSFT',5000);
/*!40000 ALTER TABLE `portfolio` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2016-04-14  2:48:28
